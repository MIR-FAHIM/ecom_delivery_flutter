...
class PendingDeliveryView extends GetView<DeliveryController> {
  PendingDeliveryView({required this.status});
    ...
    return Scaffold(
      ...
      body: SizedBox(
        ...
        child: Obx(() {
          ...
          final list = controller.deliveryOrder.where((t) => t.status!.toLowerCase().trim() == status.toLowerCase().trim())
              .toList();
